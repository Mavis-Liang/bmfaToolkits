...
`VIMSFA::cavi_msfa()` returns posterior means: - `mean_phi` (P × K):
common loading matrix Φ - `mean_lambda_s` (list of P × J_s):
study-specific loading matrices Λ_s - `mean_psi_s` (list of length-P):
residual variances ψ_s
