...
[`BFR.BE::BFR.BE.EM.CV()`](https://rdrr.io/pkg/BFR.BE/man/BFR.BE.EM.CV.html)
(or similar entry points). Because the upstream API may evolve, we keep
this wrapper flexible:
...
- ...:
  ...
  Parameters that can be pass directly to
  [`BFR.BE::BFR.BE.EM.CV()`](https://rdrr.io/pkg/BFR.BE/man/BFR.BE.EM.CV.html).
